...
public class TicketBookingRestController {
	...
	@ApiOperation("New Ticket Booking API")
	...
	@ApiOperation("API to search for a Ticket based on PNR")
	...
	public ResponseEntity<String> showHomePage(){
		return new ResponseEntity<String>("Welcome to IRCTC India", HttpStatus.OK);
	}
}
